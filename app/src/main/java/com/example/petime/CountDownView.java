...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingColor = a.getColor(R.styleable.CountDownView_ringColor, context.getResources().getColor(R.color.purple_200));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m=(mCountdownTime - (int) (mCurrentProgress / 360f * mCountdownTime))/60;
        int s=(mCountdownTime - (int) (mCurrentProgress / 360f * mCountdownTime))%60;
        String text = m + ":"+s;
